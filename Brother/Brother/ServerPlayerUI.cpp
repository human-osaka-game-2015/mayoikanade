...
ServerPlayerUI::ServerPlayerUI(Library* pLibrary, const int& Hp, int frameTexId, int barTexId, int face1id, int face2id, int face3id, float x, float y, float face_x, float face_y):
m_pLibrary(pLibrary), 
m_PlayerHp(Hp), 
...
ServerPlayerUI::~ServerPlayerUI()
{
	
}

void ServerPlayerUI::Control()
{

}

void ServerPlayerUI::Draw()
{
