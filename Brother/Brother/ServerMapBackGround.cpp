...
bool ServerMapBackGround::CsvRead(const char* filename)
{
	FILE*  fp = NULL;
...
void ServerMapBackGround::MapTex_UV_Set(float Posx, float Posy)
{
...
void ServerMapBackGround::MapTex_XY_Set(float Posx,float Posy)
{
	int count_x = int((Posx - 64) / MAPTIP_SIZE);
	int count_y = int((Posy - 64) / MAPTIP_SIZE);
...
void ServerMapBackGround::Control()
{

}

void ServerMapBackGround::Draw(float DrawPosX, float DrawPosY)
{
...
int ServerMapBackGround::BackGroundCheck(float x, float y)
{
