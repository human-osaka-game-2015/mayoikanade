...
#define RESULTCLOCK01_POS_Y 124				//時計上部の座標
#define RESULTCLOCK02_POS_X 1080			//時計中部の座標
#define RESULTCLOCK02_POS_Y 324				//時計中部の座標
#define RESULTCLOCK03_POS_X 1080			//時計下部の座標
#define RESULTCLOCK03_POS_Y 624				//時計下部の座標
#define RESULT_CLEAR_CLOCK_HANDPOSX 1079	//GameClear時の針の位置
#define RESULT_CLEAR_CLOCK_HANDPOSY 323		//GameClear時の針の位置
