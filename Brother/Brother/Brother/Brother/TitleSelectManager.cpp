...
TitleSelectManager::TitleSelectManager(Library* pLibrary, bool* pPadState, bool* pPadOldState) 
	:m_pLibrary(pLibrary), m_PadState(pPadState), m_PadOldState(pPadOldState), m_CurrentSelect(GAME_START)
{
